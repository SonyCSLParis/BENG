...
(import '(fcg::constituents fcg::dependents fcg::footprints fcg::boundaries
                            fcg::form fcg::meaning))

(def-fcg-constructions empty-construction-inventory
 ...
 :fcg-configurations (;; Form predicates
                      ...
                      (:hashed-labels hashed-string hashed-meaning hashed-lex-id cxn)
                      ;; ----------------------------------------------------------------------------------
...
(def-fcg-constructions 
 ...
 :fcg-configurations (;; Form predicates
                      ...
                      ;; For learning
                      (:consolidate-repairs . t))
 :diagnostics (diagnose-unknown-beng-word diagnose-unchunked-np)
 :repairs (repair-unknown-beng-word repair-unchunked-np)
 :visualization-configurations ((:show-wiki-links-in-predicate-networks . nil)
                                (:show-constructional-dependencies . nil)
                                (:with-search-debug-data . t))
 :hierarchy-features (constituents dependents)
...
;; (comprehend (first *test-preprocessing*))
