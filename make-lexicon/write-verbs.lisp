...
(defun write-verb-lex-cxn (out lemma &optional verb-type meaning)
  ...
  (format out "~%               (sem-valence  (actor ?x) (undergoer ?y))")
  (format out "~%               (sem-cat (sem-class predicate)")
  (format out "~%                        (emphasis ~a))" (if (eql verb-type 'ergative) '?y '?x))
  (format out "~%               (syn-cat (syn-function ?syn-function)")
  (format out "~%                        (verb-form ?vf)")
  (format out "~%                        (finite ?fin)")
  (format out "~%                        (agreement ?agr)")
  (format out "~%                        (tam ?tam)))")
  (format out "~%              <-")
  (format out "~%              (?~a-unit" lemma)
  (format out "~%               (hash meaning ((frame-type event ~a ?ev)" meaning)
  (format out "~%                              (slot ~a-1 ?ev ?x)" meaning)
  (format out "~%                              (slot ~a-2 ?ev ?y)))" meaning)
  (format out "~%               --")
